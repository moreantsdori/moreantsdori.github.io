...
var ZCUtil = new function()
{
	...
	this.sendRequest = function(url, urlParams, resptype, callback, args, msg, hideLoading)
	{
		...
		if((ZCUtil.contains(ZCApp.csrfArray, url) || urlParams.indexOf(getCsrfParamName()) == -1) && (url.indexOf(ZCApp.compProps["actionURL-2"]) == -1))
		{
		...
		if(url.indexOf(ZCApp.compProps["actionURL-2"]) != -1){
...
//            		if(typeof isBrowserDeprecated != 'undefined')
//        			{
//            			adjustTop = (typeof ZCBannerTop != 'undefined' ) ? adjustTop + ZCBannerTop.height : adjustTop;
//        			}
//            		if(typeof isskydeskBannerEnabled != 'undefined')
//        			{
//          				adjustTop = (typeof ZCBannerTop != 'undefined' ) ? adjustTop + ZCBannerTop.height : adjustTop;
//      				}
            			...
            			if(typeof showSecurityBanner != 'undefined')
        				{
            				adjustTop = (typeof ZCBannerTop != 'undefined' ) ? adjustTop + ZCBannerTop.height : adjustTop;
        				}
